...
# Constants
IMAGE_SIZE = 96
MODEL_DIR = "models/squeezenet_96x96_full_epochs_with_unknown"
...
if __name__ == "__main__":
    try:
        print("=== EVALUATING SQUEEZENET 96x96 MODEL (FULL EPOCHS) ===")
        ...
        with open(os.path.join(MODEL_DIR, "evaluation", "classification_report.txt"), 'w', encoding='utf-8') as f:
            f.write(f"Model: SqueezeNet 96x96 (Full Epochs with Unknown)\n")
